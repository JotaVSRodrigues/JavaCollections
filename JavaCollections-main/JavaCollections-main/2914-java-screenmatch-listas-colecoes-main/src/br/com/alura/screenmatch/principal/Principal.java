...
public class Principal {
    public static void main(String[] args) {
        ...
        filmeDoJoao.setDuracaoEmMinutos(120);
        filmeDoJoao.avalia(10);

        var filmeDoJoao2 = new Filme("Interstellar", 2014);
        var filmeDoJoao3 = new Filme("Shrek", 2001);
        ...
        Pessoa pessoa1 = new Pessoa("Joao", 17);
        Pessoa pessoa2 = new Pessoa("Kelvin", 16);
        Pessoa pessoa3 = new Pessoa("Boza", 18);
